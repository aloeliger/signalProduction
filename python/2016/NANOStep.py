...
# with command line options: --filein=file:fileOutput/step1_MiniAOD.root --fileout=file:testNanoAOD.root -s NANO --mc --eventcontent NANOAODSIM --datatier NANOAODSIM --conditions 106X_mcRun2_asymptotic_v13 --era Run2_2016 -n 100 --no_exec
