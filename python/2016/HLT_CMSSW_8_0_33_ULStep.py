...
# with command line options: step1 --fileout file:B2G-RunIISummer20UL16HLT-00449.root --mc --eventcontent RAWSIM --outputCommand keep *_mix_*_*,keep *_genPUProtons_*_* --datatier GEN-SIM-RAW --inputCommands keep *,drop *_*_BMTF_*,drop *PixelFEDChannel*_*_*_* --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --customise_commands process.source.bypassVersionCheck = cms.untracked.bool(True) --step HLT:25ns15e33_v4 --nThreads 8 --geometry DB:Extended --era Run2_2016
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:B2G-RunIISummer20UL16HLT-00449.root'),
